...
| 50    | 0.16 ms      | 0.18 ms      | 1.1x faster |
| 100    | 0.18 ms      | 0.36 ms      | 2.0x faster |
| 500    | 0.88 ms      | 1.73 ms      | 2.0x faster |
...
| 100    | 0.16 ms      | 0.36 ms      | 2.2x faster |
| 500    | 0.67 ms      | 1.82 ms      | 2.7x faster |

#### Edit Re-masking Performance

| Lines | shelter.nvim | cloak.nvim | Difference |
|-------|--------------|------------|------------|
| 10    | 0.06 ms      | 0.04 ms      | 1.4x slower |
| 50    | 0.20 ms      | 0.21 ms      | 1.1x faster |
| 100    | 0.42 ms      | 0.34 ms      | 1.2x slower |
| 500    | 1.93 ms      | 1.96 ms      | ~same |
