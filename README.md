...
|-------|--------------|------------|------------|
| 10    | 0.09 ms      | 0.07 ms      | 1.3x slower |
| 50    | 0.15 ms      | 0.16 ms      | 1.1x faster |
| 100    | 0.19 ms      | 0.34 ms      | 1.8x faster |
| 500    | 0.82 ms      | 1.67 ms      | 2.0x faster |
...
| 50    | 0.13 ms      | 0.16 ms      | 1.2x faster |
| 100    | 0.17 ms      | 0.34 ms      | 2.0x faster |
| 500    | 0.77 ms      | 1.65 ms      | 2.1x faster |

#### Edit Re-masking Performance

| Lines | shelter.nvim | cloak.nvim | Difference |
|-------|--------------|------------|------------|
| 10    | 0.05 ms      | 0.04 ms      | 1.2x slower |
| 50    | 0.18 ms      | 0.18 ms      | ~same |
| 100    | 0.39 ms      | 0.33 ms      | 1.2x slower |
| 500    | 2.12 ms      | 1.58 ms      | 1.3x slower |
